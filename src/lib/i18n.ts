...
const translations = {
  en: {
    ...
    manual: {
      ...
      boostDesc: 'Spend 4 PDS capacity to discard your entire hand and draw the same number of cards. Can be used once per turn.',
      archiveTitle: 'Label',
  ...
  jp: {
    ...
    manual: {
      ...
      boostDesc: 'PDS容量を4使い、手札をすべて捨てて同じ枚数ドローしなおします。1ターンに1度だけ使用できます。',
      archiveTitle: 'ラベル',
